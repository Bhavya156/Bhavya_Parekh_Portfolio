...
//       // Ensure the fancybox content container is scrollable
...
//       // Ensure the inner content is a flex container
//       $('.fancybox-inner').css({
//         'display': 'flex',
//         'flex-direction': 'column',
//         'align-items': 'center',
...
//       // Ensure the image retains its size and add space below
//       // $('.fancybox-image').css({
//       //   'max-width': '100%',
//       //   'height': 'auto',
//       //   'margin-bottom': '20px'
...
//       // Ensure the caption aligns with the image width and justify its content
